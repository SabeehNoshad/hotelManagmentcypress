...
describe('adding menu item ', () => { 
    it('should add the item in the menu sucessfully',()=>{
        login()
  ...
  cy.contains('span.ant-menu-title-content', 'Restaurant', { timeout: 10000 })
    ...
    .click();
        ...
        .click();
        cy.visit('http://localhost:3000/restaurants/1/menu')
        cy.get("body > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > button:nth-child(1) > span:nth-child(2)")
        .click
        addMenuItem({
            name: randomName,
            description: randomtext,
            price:"415",
            ingredientName:["pepper","salt","sugar","baking powder"]

        })
        cy.get("button[class='ant-btn css-dev-only-do-not-override-sqr1i9 ant-btn-primary ant-btn-color-primary ant-btn-variant-solid bg-orange-500 hover:bg-orange-600'] span").click()
    })
})